...
public class EcoProductOffers {
	...
	public EcoProductOffers(long productid, LocalDate offerstartDate, LocalDate offersEndDate, String name,
			String description) {
		super();
		this.productid = productid;
		this.offerstartDate = offerstartDate;
