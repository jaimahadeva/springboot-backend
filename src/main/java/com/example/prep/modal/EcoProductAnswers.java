...
@Entity
public class EcoProductAnswers {
	@Id
	...
	public EcoProductAnswers(long productid, String username, long userId, String answer, long likescount,
			String userphoto) {
		super();
		this.productid = productid;
		this.username = username;
