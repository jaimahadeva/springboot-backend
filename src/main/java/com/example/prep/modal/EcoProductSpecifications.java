...
@Entity
public class EcoProductSpecifications {
	@Id
	...
	public EcoProductSpecifications() {
	...
	public EcoProductSpecifications(long productid, long userid, String heading, String answer) {
		super();
		this.productid = productid;
		this.userid = userid;
		this.heading = heading;
